...
insert into techstack (category, name, icon, color, sort_order) values
  ...
  ('Fullstack Development', 'React JS', 'SiReact', '#61DAFB', 1),
  ('Fullstack Development', 'HTML', 'SiHtml5', '#E34F26', 2),
  ('Fullstack Development', 'CSS', 'SiCss3', '#1572B6', 3),
  ('Fullstack Development', 'Tailwind', 'SiTailwindcss', '#06B6D4', 4),
  ('Fullstack Development', 'Chakra UI', 'SiChakraui', '#319795', 5),
  ('Fullstack Development', 'Bootstrap', 'SiBootstrap', '#7952B3', 6),
  ('Fullstack Development', 'Framer Motion', 'SiFramer', '#0055FF', 7),
  ('Fullstack Development', 'Redux', 'SiRedux', '#764ABC', 8),
  ('Fullstack Development', 'PostgreSQL', 'SiPostgresql', '#4169E1', 9),
  ('Fullstack Development', 'Supabase', 'SiSupabase', '#3ECF8E', 10),
