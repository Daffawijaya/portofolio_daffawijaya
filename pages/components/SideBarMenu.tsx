...
const SidebarMenu = () => {
    ...
    return (
        <>
            <button onClick={() => setShow(true)} className="hover:scale-105 duration-300 ">
...

            {
                ...
                <div onClick={() => setShow(false)} className='bg-black fixed top-0 left-0 h-screen w-screen z-50 backdrop-blur-sm bg-opacity-50'>
                    <div onClick={(e) => e.stopPropagation()} className='bg-a-2 h-full w-[67%] px-[10%] flex flex-col items-start justify-between py-8'>
                        <div></div>
