...
const SidebarMenu = () => {
    ...
    return (
        <>
            <button onClick={() => setShow(true)} className="hover:scale-105 duration-300 md:rotate-0 rotate-90 mb-32 md:mb-0">
...

            {
                ...
                <div onClick={() => setShow(false)} className='bg-black fixed top-0 left-0 h-screen w-screen z-50 backdrop-blur-sm bg-opacity-50'>
                    <div onClick={(e) => e.stopPropagation()} className='bg-a-2 h-full w-[75%] md:w-[67%] px-[5%] md:px-[10%] flex flex-col items-start justify-between py-8'>
                        <div></div>
                        <div className='font-bold text-5xl md:text-7xl text-start'>
